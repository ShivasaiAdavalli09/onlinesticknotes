...
//in this project we are generating automatic service-worker.js by using command npm install --global sw-precache and then one more 
//sw-precache,these two commands automatically creates service-worker.js file instead of manually creating by us
